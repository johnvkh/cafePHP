...
class Store_reportuser_model extends CI_Model {
    ...
    public function Exportexcel($data) {
        ...
        $query = $this->db->query('SELECT 
    sh.cus_name as "ຊື່ລູກຄ້າ",
    sd.product_code as "ລະຫັດສິນຄ້າ",
	sd.product_name as "ຊື່ສິນຄ້າ",
	sd.product_price as "ລາຄາຂາຍ",
    sd.product_price_discount as "ສ່ວນຫຼຸດ",
	sd.product_sale_num as "ຈຳນວນທີ່ຊື້",
	(sd.product_price*sd.product_sale_num)-(sd.product_sale_num*sd.product_price_discount) as "ລາຍຮັບ",
	from_unixtime(sd.adddate,"%d-%m-%Y %H:%i:%s") as "ວັນທີ"
