...
<input type="text" class="form-control" ng-model="discount_last" placeholder="ລົດຈໍານວນເງິນ" style="font-size: 30px;text-align: right;height: 47px;background-color:#dff0d8;width: 200px;">
...
<span ng-if="x.cus_name!=null">
	<br />
<button class="btn btn-default btn-xs" ng-click="printDivfullsend(x)">ພິມໃບໃສ່ໜ້າກ່ອງ</button>
</span>
			</td>
...
<table class="table table-hover table-bordered">
	<thead>
		<tr class="trheader">
			<th>ເລືອກ</th><th>ລະຫັດສິນຄ້າ</th><th>ຊື່ສິນຄ້າ</th><th>ລາຄາ</th><th>ສ່ວນລົດຕໍ່ໝ່ວຍ</th>
		</tr>
	</thead>
	<tbody>
...
<?php } ?>
		...
		<tr><td align="right" colspan="7">
			<span ng-if="pay_type=='4'">ຄ້າງຊໍາລະ</span>
...
<div class="modal fade" id="Openonesend">
	...
	<select ng-model="lung" ng-change="Selectlung(lung)" class="form-control" style="font-size: 20px;text-align: center;height: 40px;">
		<option value="1">
			ເລືອກພິມໃບຕິດໜ້າກ້ອງ A4
		</option>
		<option value="2">
			ເລືອກໃບຕິດໜ້າກ້ອງນ້ອຍ
		</option>
	</select>
	<button class="btn btn-primary" ng-click="printDiv()"><?=$lang_print?></button>
			<div class="modal-body" id="section-to-print2">
