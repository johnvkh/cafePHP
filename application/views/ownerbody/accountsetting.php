...
<div class="row">
<div class="col-md-4">
	<input type="text" placeholder="ຊື່" name="" class="form-control" ng-model="owner_name" >
...
<div class="col-md-4">
<input type="password" placeholder="ລະຫັດຜ່ານ" name="" class="form-control" ng-model="owner_password" >
</div>
...
toastr.success('ບັນທຶກຮຽບຮ້ອຍ');
	...
	toastr.warning('ກະລຸນາບັອກລະຫັດຜ່ານ!!!');
}
