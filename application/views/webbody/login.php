    ...
    <div class="row vertical-offset-100">
        <div class="col-md-4 col-md-offset-4">
            <?php if (isset($_GET['regis'])) { ?>
                <div><p class="text-center" style="color: green;border-style: dotted;border-width: 1px;">ສະໝັກສະມາຊິກສຳເລັດ!</p></div>
            <?php } ?>
            ...
            <div class="panel panel-warning">
                <div class="panel-heading" style="background-color: #fff;">
                    <center><h1 class="panel-title" style="font-size: 35px;"><?= $lang_project_name ?></h1></center>
                </div>
