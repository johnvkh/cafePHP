                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <button class="btn btn-default" ng-click="Updatelogomodal(x)"><?= $lang_upload_logo ?></button>
                        </td>
                        <td>{{x.owner_name}}</td>
                        <td>
                            {{x.owner_address}}
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success" ng-click="Updatefooter_slip(x)"><?= $lang_save ?></button>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align: center;">
                            <button class="btn btn-default" ng-click="Updatebgimgmodal(x)"><?= $lang_upload_background ?></button>
                            <hr />
